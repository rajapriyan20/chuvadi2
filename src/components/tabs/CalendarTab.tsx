...
type EventFilterType = 'ALL' | 'FINANCE' | 'VEHICLE' | 'EXERCISE' | 'MENSTRUAL' | 'CUSTOM';
...
export const CalendarTab: React.FC<CalendarTabProps> = ({
  ...
  const dateEventsMap = useMemo(() => {
    ...
    return map;
  }, [transactions, vehicles, vehicleLogs, exerciseLogs, calendarEvents, menstrualLogs, entities]);
  ...
  const monthStats = useMemo(() => {
    ...
    return { totalExpense: exp, totalIncome: inc, workoutDays: workouts, periodDays };
  }, [transactions, exerciseLogs, menstrualLogs, year, month]);
  ...
  return (
    <div className="space-y-5 pb-12">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {/* Period or Workout indicator icons */}
                  ...
                  {hasItems && (
                    <div className="text-[9px] text-slate-500 text-right mt-1 font-mono">
                      {txns.length + customEvts.length + vehEvents.length + exercises.length} item{txns.length + customEvts.length + vehEvents.length + exercises.length > 1 ? 's' : ''}
                    </div>
                  )}
                </div>
              );
            ...
            <div className="p-4 overflow-y-auto space-y-4 flex-1">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-xs transition"
                >
                  <Plus size={14} />
                ...
                {onOpenQuickAddTxn && (
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold border border-slate-700 transition"
                  >
                    <Plus size={14} />
      ...
      {/* ========================================================= */}
      {/* CUSTOM CALENDAR EVENT ADD/EDIT MODAL                      */}
      {/* ========================================================= */}
      {isEventModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
            ...
            <form onSubmit={handleSaveEventSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-slate-950 text-xs font-bold transition shadow-sm"
                  >
                    Save Event
                  </button>
                </div>
